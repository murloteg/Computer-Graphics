...
public class SobelOperator implements Instrument, DialogEnabled {
    ...
    public SobelOperator(ImagePanel imagePanel) {
    ...
    public void injectActionListeners(List<Instrument> instrumentList, ButtonGroup buttonGroup) {
        ...
        instrumentButton.addActionListener(event -> {
            showDialog();
            imagePanel.setFilterMode(FilterMode.SOBEL_OPERATOR);
